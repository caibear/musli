...
//! let version2 = musli_self::to_vec(&Version2 {
//!     name: String::from("Aristotle"),
//!     age: Some(62),
//! })?;
//!
//! let version1: Version1 = musli_self::decode(&version2[..])?;
//!
...
//! [SelfEncoding::with_max_pack].
//!
//! [default encoding format]: https://docs.rs/musli-wire/latest/musli-wire/struct.SelfEncoding.html
//! [MAX_INLINE_LEN]: https://docs.rs/musli-wire/latest/musli_self/tag/constant.MAX_INLINE_LEN.html
//! [Müsli]: https://docs.rs/musli
//! [SelfEncoding::with_max_pack]: https://docs.rs/musli-wire/latest/musli_self/encoding/struct.SelfEncoding.html#method.with_max_pack
